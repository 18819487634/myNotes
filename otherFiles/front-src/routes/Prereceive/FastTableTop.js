...
export default class FastTableTop extends PureComponent {
  ...
  handleFieldCascaderChange(e, fieldName, key) {
  ...
  <div>
    ...
    <Input value={record.shipphone} style={{ fontWeight: 600,float:"left",width:150 }} onChange={e => this.handleFieldChange(e, 'shipphone', record.key)}  />
          ...
          // else if(`${record.key}`=== "comment1" && val.length<3){
          //   return { 
          //     children :<div><span style={{ fontWeight: 600,float:"left" ,width:100,marginTop:8}} >备注</span><Input style={{ fontWeight: 600,float:"left",width:400 }} /></div>,
          //         props:{
          //           colSpan:8,
          //         },
          //       }
